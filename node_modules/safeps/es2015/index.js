 ...
 */
	getPossibleExecPaths: function getPossibleExecPaths(execName) {
		...
		if (_isWindows && execName.indexOf('.') === -1) {
			...
			try {
				for (var _iterator = standardExecPaths[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var standardExecPath = _step.value;
 ...
 * @return {this}
 */
	initOrPullGitRepo: function initOrPullGitRepo(opts, next) {
		...
		safefs.ensurePath(opts.cwd, function (err, exists) {
			if (err) {
				...
				safeps.spawn(['git', 'pull', opts.remote, opts.branch], opts, function (err) {
					for (var _len3 = arguments.length, result = Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
 ...
 */
	initNodeModules: function initNodeModules(opts, next) {
		...
		var _extractOptsAndCallba35 = extractOptsAndCallback(opts, next);
		// Prepare


		var _extractOptsAndCallba36 = _slicedToArray(_extractOptsAndCallba35, 2);

		opts = _extractOptsAndCallba36[0];
		next = _extractOptsAndCallba36[1];
		if (!opts.cwd) opts.cwd = process.cwd();
		...
		try {
			for (var _iterator2 = args[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				...
				if (Array.isArray(arg)) {
					...
					try {
						for (var _iterator3 = Object.keys(arg)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
